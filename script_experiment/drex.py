...
from script_experiment.drex_utils import RewardNet, Model
from script_experiment.noisy_dataset import BCNoisePreferenceDataset
...
def train_reward(args):
    ...
    for i, model in enumerate(models):
        D = dataset.sample(args.D, args, include_action=args.include_action)
...
def eval_reward(args):
    ...
    save_path = os.path.join(args.log_dir, 'trex', 'gt_vs_pred_rewards.png')
